...
if($options == 'save'){
    $id=$_GET['id'];
                                    ...
                                    $db->update('user',array('username'=>$username, 'password' => $password, 'status' => $status),'id_user='.$editid); 
...
$db->sql('SELECT * FROM user WHERE id_user='.$editid);
$res = $db->getResult();
foreach($res as $output){
    //echo $output["name"]."<br />";

?>
                                    <form action="edit-user.php?options=save&id=<?php echo $editid;?>" method="POST" class="form-bordered">
                                        <div class="form-group">
                                            <label for="example-nf-email">Username</label>
                                            <input type="text" id="username" value="<?php echo $output['username'];?>" name="username" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-nf-password">Last Password</label>
                                            <input type="text" id="password"  value="<?php echo $output['password'];?>" disabled class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-nf-password">New Password</label>
                                            <input type="password" id="password" name="password"  value="<?php echo $output['password'];?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group form-actions">
                                            ...
                                            <button type='reset'onclick="window.location.href='view-user.php'" class="btn btn-effect-ripple btn-danger" style="overflow: hidden; position: relative;"><span class="btn-ripple animate" style="height: 61px; width: 61px; top: -20.9688px; left: 7.46875px;"></span>Cancel</button>
                                        </div>
