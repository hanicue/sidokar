        ...
        <table id="example-datatable" class="table table-striped table-bordered table-vcenter dataTable no-footer" role="grid" aria-describedby="example-datatable_info">
            <thead>
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example-datatable" rowspan="1" colspan="1" aria-label="User: activate to sort column ascending" style="width: 192px;">Turun Ke</th>
...
$i++;
                ...
                <tr role="row" class="odd">
                    ...
                    <td><strong> <?php echo $output["tgl_masuk"]; ?></strong></td>
                    ...
                    <td><?php echo $output["turun_ke"]; ?></td>
                    <td><?php echo $output["ket"]; ?></td>
                    <td><span class="label label-danger">Disabled</span></td>
                    <td class="text-center">
                        <a href="edit-inbox.php?id=<?php echo $output["id_masuk"];?>" data-toggle="tooltip" title="" class="btn btn-effect-ripple btn-xs btn-success" style="overflow: hidden; position: relative;" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                        <a href="delete-inbox.php?id=<?php echo $output["id_masuk"]; ?>" data-toggle="tooltip" title="" class="btn btn-effect-ripple btn-xs btn-danger" style="overflow: hidden; position: relative;" data-original-title="Delete"><i class="fa fa-times"></i></a>
                    </td>
                </tr>
